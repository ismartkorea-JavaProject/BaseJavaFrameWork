package ko.co.sonsystem.system.policy.filter;
...
import ko.co.sonsystem.system.policy.service.LoginPolicyVO;
import ko.co.sonsystem.system.policy.service.SysLoginPolicyService;
/**
 * 로그인 정책 체크 필터
...
public class SysLoginPolicyFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		SysLoginPolicyService egovLoginPolicyService = (SysLoginPolicyService) act.getBean("sysLoginPolicyService");

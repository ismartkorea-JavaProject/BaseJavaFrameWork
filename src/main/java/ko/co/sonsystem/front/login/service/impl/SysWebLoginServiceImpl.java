package ko.co.sonsystem.front.login.service.impl;
...
public class SysWebLoginServiceImpl extends EgovAbstractServiceImpl implements
        SysWebLoginService {

    @Resource(name="sysWebLoginDAO")
    private SysWebLoginDAO loginDAO;

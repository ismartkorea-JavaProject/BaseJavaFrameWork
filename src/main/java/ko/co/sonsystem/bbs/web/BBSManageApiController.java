package ko.co.sonsystem.bbs.web;
 ...
 */
@RestController
@Tag(name="BBSManageApiController",description = "게시물 관리")
public class BBSManageApiController {
	...
	@Operation(
			...
			tags = {"BBSManageApiController"}
	)
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "조회 성공"),
			@ApiResponse(responseCode = "403", description = "인가된 사용자가 아님")
	})
	@PostMapping(value = "/bbs/selectBoardListAPI.do", consumes = MediaType.APPLICATION_JSON_VALUE)	
	...
	@PostMapping(value = "/bbs/selectBoardArticleAPI.do")
	...
	@PostMapping(value ="/bbs/insertBoardArticleAPI.do")
	...
	@PostMapping(value ="/bbs/replyBoardArticleAPI.do")
	...
	@PostMapping(value ="/bbs/updateBoardArticleAPI.do")
	...
	@PutMapping(value = "/bbs/deleteBoardArticleAPI/{nttId}.do")
